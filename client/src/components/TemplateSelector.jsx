...
const TemplateSelector = ({ selectedTemplate, onChange }) => {
    ...
    const template = [
        ...
        },
        {
            id: "modern",
            name: "Modern",
            preview: "A contemporary design with bold headings, vibrant colors, and a dynamic layout to make your resume stand out"
        },
        {
            id: "minimal-image",
            name: "Minimal with image",
            preview: "A sleek minimalist design that incorporates a profile image, clean lines, and ample white space for a polished look"
        },
        {
            id: "minimal",
            name: "Minimal",
            preview: "A simple and elegant design with a focus on typography and layout, using minimal colors and graphics for a sophisticated appearance"
        }
