...
function Features() {
 ...
 return (
        ...
        <Title title='build your resume' description='Our streamlined process helps you create a professional resume in minutes with intelligent AI-Powered tool and features.'/>
